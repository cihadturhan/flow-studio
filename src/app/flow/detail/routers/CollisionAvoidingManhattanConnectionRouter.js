draw2d.layout.connection.CollisionAvoidingManhattanConnectionRouter = draw2d.layout.connection.ConnectionRouter.extend({
    NAME: "draw2d.layout.connection.CollisionAvoidingManhattanConnectionRouter",
